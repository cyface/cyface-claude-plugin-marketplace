...
| [coolify](https://github.com/cyface/coolify-claude-plugin) | Interact with a self-hosted Coolify instance via its REST API — manage applications, databases, deployments, servers, services, and projects. |
